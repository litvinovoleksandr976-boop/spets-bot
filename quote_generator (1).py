...
_FONT_CANDIDATES = [
    # 1. Bundled fonts inside our project (works on Railway and locally)
    ...
    # 2. Path on Debian/Ubuntu (fallback if system has fonts)
    ("/usr/share/fonts/truetype/dejavu/DejaVuSans.ttf",
     "/usr/share/fonts/truetype/dejavu/DejaVuSans-Bold.ttf"),
    # 3. Alpine / minimal containers
    ("/usr/share/fonts/TTF/DejaVuSans.ttf",
     "/usr/share/fonts/TTF/DejaVuSans-Bold.ttf"),
    # 4. Liberation fonts as alternative
