"""
SPETS SECURITY — Email sender via Resend (3 packages)
...
def send_3_packages_email(
    ...
    """
    Send one email with 3 PDFs (Budget/Balance/Elite) attached.
    ...
    # Localized labels
    label_total = t("email_total_label", lang)
      ...
      <div style="max-width: 640px; margin: 0 auto; padding: 20px;">
        ...
        <div style="padding: 30px 20px;">
          ...
          <table style="width: 100%; margin: 20px 0; border-collapse: collapse;">
            ...
            <!-- Elite -->
            <tr>
              <td style="padding: 15px; background: #FFF8E1; border-left: 5px solid #C9A227; border-radius: 4px;">
                <div style="font-size: 18px; font-weight: bold; color: #C9A227;">🟡 Elite</div>
          ...
          <p style="background: #F0F4F8; padding: 12px; border-left: 4px solid #FCA311;">
            📎 {attachments_note}
          </p>
    ...
    payload = {
        ...
        "html": html_body,
        "attachments": [
            {"filename": f"Spets-Quote-{quote_number}-Budget.pdf",  "content": _b64(pdfs["budget"])},
            {"filename": f"Spets-Quote-{quote_number}-Balance.pdf", "content": _b64(pdfs["balance"])},
            {"filename": f"Spets-Quote-{quote_number}-Elite.pdf",   "content": _b64(pdfs["elite"])},
        ],
    }
